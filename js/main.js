...
blue_btn.addEventListener("click", function onClick(event) {
  ...
  controls.style.backgroundImage = 'url("../resources/images/4_3_f.png")';

  if (width > 767) {
    caseimg.style.backgroundImage = 'url("../resources/images/c_2.png")';
  } else {
    caseimg.style.backgroundImage = 'url("../resources/images/c_1_1.png")';
  }
...
red_btn.addEventListener("click", function onClick(event) {
  ...
  controls.style.backgroundImage = 'url("../resources/images/4_3_f_1.png")';
  if (width > 767) {
    caseimg.style.backgroundImage = 'url("../resources/images/c_1.png")';
  } else {
    caseimg.style.backgroundImage = 'url("../resources/images/c_1_3.png")';
  }
...
gold_btn.addEventListener("click", function onClick(event) {
  ...
  controls.style.backgroundImage = 'url("../resources/images/4_3_f_3.png")';
  if (width > 767) {
    caseimg.style.backgroundImage = 'url("../resources/images/c_3.png")';
  } else {
    caseimg.style.backgroundImage = 'url("../resources/images/c_1_4.png")';
  }
...
black_btn.addEventListener("click", function onClick(event) {
  ...
  controls.style.backgroundImage = 'url("../resources/images/4_3_f_2.png")';
  if (width > 767) {
    caseimg.style.backgroundImage = 'url("../resources/images/c_4.png")';
  } else {
    caseimg.style.backgroundImage = 'url("../resources/images/c_1_2.png")';
  }
